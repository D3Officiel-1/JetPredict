                    ...
                    <TabsContent value="how-to">
                        <div className="py-4 space-y-6 max-h-[60vh] overflow-y-auto pr-4">
                            ...
                            <StrategyItem title="9. Martingale modifiée">
                                <p>Pour limiter le risque, ne double pas trop vite tes mises.</p><p>Exemple : 500 → 1 000 → 1 500 FCFA au lieu de doubler systématiquement.</p><p>Cette méthode permet de récupérer les pertes plus lentement, mais plus sûr.</p><p>Elle te protège contre des crashes consécutifs élevés qui peuvent tout brûler.</p><p>Combine-la avec des retraits sécurisés pour limiter les pertes.</p><p>C’est une version plus prudente et adaptée aux petits capitales.</p>
                            </StrategyItem>
                            <StrategyItem title="10. Fibonacci">
                                <p>Augmente la mise selon la suite de Fibonacci après chaque perte : 500 → 500 → 1 000 → 1 500 → 2 500.</p><p>Après un gain, retourne à la mise initiale pour sécuriser ton capital.</p><p>C’est moins risqué que la martingale classique mais reste efficace pour récupérer des pertes.</p><p>Idéal pour les joueurs qui observent les tendances et veulent une progression contrôlée.</p><p>Tu peux adapter la suite selon ton capital et tes objectifs.</p><p>C’est une stratégie solide pour gérer les séries de pertes.</p>
                            </StrategyItem>
                            <StrategyItem title="11. Mise fractionnelle">
                                <p>Ne joue jamais ton capital entier sur un tour.</p><p>Mise seulement une fraction du gain potentiel que tu veux atteindre.</p><p>Exemple : capital 50 000 FCFA → mise = 10 % du gain visé.</p><p>Cela limite la perte en cas de crash et te permet de jouer plus longtemps.</p><p>C’est parfait pour diversifier tes paris sur plusieurs multiplicateurs.</p><p>Tu gardes ainsi le contrôle de ton capital tout en cherchant de gros gains.</p>
                            </StrategyItem>
                            <StrategyItem title="12. Analyse des patterns">
                                <p>Certains jeux affichent l’historique des multiplicateurs.</p><p>Note les tendances : après plusieurs tours bas, un multiplicateur élevé est plus probable.</p><p>Ne mise pas gros quand le multiplicateur reste constamment bas.</p><p>Cherche les cycles ou répétitions qui peuvent influencer ton timing.</p><p>Ce n’est jamais garanti, mais l’observation augmente tes chances de gains.</p><p>C’est un outil stratégique que beaucoup de joueurs ignorent.</p>
                            </StrategyItem>
                            <StrategyItem title="13. Fixer un objectif">
                                <p>Détermine un objectif clair par session, par exemple 10 000 FCFA de gains.</p><p>Une fois atteint, arrête de jouer pour sécuriser tes profits.</p><p>Cela évite de tout perdre par excès de confiance.</p><p>Tu peux aussi définir des mini-objectifs pour suivre ta progression.</p><p>Cette discipline transforme un jeu aléatoire en session rentable.</p><p>Objectifs = motivation + limite psychologique pour contrôler le jeu.</p>
                            </StrategyItem>
                            <StrategyItem title="14. Plafond de perte">
                                <p>Détermine combien tu es prêt à perdre par session, ex. 20 % du capital.</p><p>Une fois atteint, stop immédiat.</p><p>Évite les pertes cumulées qui peuvent décourager et ruiner ton capital.</p><p>Cela impose une discipline stricte et protège ton capital sur le long terme.</p><p>Combine avec un objectif de gain pour équilibrer risque et profit.</p><p>Ne jamais dépasser ton plafond = règle d’or.</p>
                            </StrategyItem>
                            <StrategyItem title="15. Ne pas courir après les pertes">
                                <p>Perdre plusieurs tours de suite peut déclencher l’adrénaline.</p><p>Ne mise pas plus pour tenter de récupérer tes pertes rapidement.</p><p>C’est la manière la plus rapide de tout perdre.</p><p>Fais une pause ou reprends avec des mises sécurisées.</p><p>Apprendre à accepter les pertes est clé pour un jeu rentable.</p><p>Le contrôle émotionnel est plus important que la stratégie technique.</p>
                            </StrategyItem>
                            <StrategyItem title="16. Fractionner les mises">
                                <p>Divise ton capital en plusieurs petites mises sur différents multiplicateurs.</p><p>Exemple : 50 000 FCFA → 5 mises de 1 000 FCFA + 10 mises de 500 FCFA.</p><p>Cela te permet de sécuriser des gains constants tout en tentant des multiplicateurs élevés.</p><p>Chaque mini-mise agit comme un pari indépendant.</p><p>Réduit le risque global et augmente tes chances de gains cumulés.</p><p>C’est une technique que les pros utilisent pour gérer le capital efficacement.</p>
                            </StrategyItem>
                            <StrategyItem title="17. Timing du retrait">
                                <p>Le timing est essentiel : retirer trop tôt = petits gains, trop tard = perte.</p><p>Observe la montée du multiplicateur et fixe un seuil cible par tour.</p><p>Exemple : retirer à 1,8x pour sécuriser ou à 3x pour un peu plus de profit.</p><p>Adapte selon ton capital et ton objectif de gain.</p><p>Ne jamais baser le timing uniquement sur le feeling.</p><p>L’observation et l’expérience permettent de trouver le bon moment pour retirer.</p>
                            </StrategyItem>
                            <StrategyItem title="18. Combinaison des stratégies">
                                <p>Ne te limite pas à une seule stratégie.</p><p>Combine retraits sécurisés, martingale modifiée et mises fractionnelles pour équilibrer risque et gain.</p><p>Exemple : 70 % des mises sécurisées, 20 % en retrait moyen, 10 % en gros multiplicateur.</p><p>Cela permet de rester rentable même si certains tours crashent.</p><p>Tu diversifies tes paris comme un trader gère un portefeuille.</p><p>La combinaison est plus efficace qu’une seule stratégie isolée.</p>
                            </StrategyItem>
                            <StrategyItem title="19. Profiter des bonus">
                                <p>Beaucoup de casinos offrent bonus, free bets ou tours gratuits.</p><p>Exemple : 10 % bonus sur dépôt = capital supplémentaire à jouer sans risque réel.</p><p>Cela permet de tester des stratégies ou multiplier tes gains.</p><p>Lis toujours les conditions pour ne pas te retrouver piégé.</p><p>Les bonus peuvent transformer une session moyenne en session rentable.</p><p>C’est une ressource sous-utilisée par la plupart des joueurs.</p>
                            </StrategyItem>
                            <StrategyItem title="20. Suivi des gains">
                                <p>Note chaque tour : mise, multiplicateur, gain/perte.</p><p>Exemple : tableau Excel pour suivre les résultats en FCFA.</p><p>Tu verras les patterns et l’efficacité de tes stratégies.</p><p>Cela permet d’ajuster ton approche en temps réel.</p><p>Le suivi rend le jeu moins aléatoire et plus scientifique.</p><p>C’est la base pour évoluer vers un joueur discipliné et rentable.</p>
                            </StrategyItem>
                            <StrategyItem title="21. Discipline">
                                <p>Respecte strictement limites de mise, plafond de perte et objectifs de gain.</p><p>Ne change jamais de stratégie sous l’effet des émotions.</p><p>Les joueurs impulsifs perdent rapidement tout leur capital.</p><p>La discipline est plus importante que la chance.</p><p>Établir des règles avant de jouer te protège de l’excès de confiance.</p><p>Elle transforme un jeu de hasard en jeu géré et stratégique.</p>
                            </StrategyItem>
                            <StrategyItem title="22. Pauses régulières">
                                <p>Jouer fatigué = décisions mauvaises = pertes assurées.</p><p>Fais des pauses toutes les 15–30 minutes pour rester lucide.</p><p>Profite-en pour analyser les tours précédents et ajuster tes stratégies.</p><p>Respire, éloigne-toi de l’écran et reviens avec un esprit clair.</p><p>Les pros ne jouent jamais en continu sans repos.</p><p>Le mental est ton meilleur allié pour maximiser tes gains.</p>
                            </StrategyItem>
                            <StrategyItem title="23. Mental fort">
                                <p>Reste calme face aux pertes et aux gains rapides.</p><p>Ne laisse pas l’adrénaline influencer tes décisions.</p><p>Accepte que le hasard fera toujours partie du jeu.</p><p>La constance mentale permet de rester rentable sur le long terme.</p><p>Prends des notes, analyse, ajuste et continue avec discipline.</p><p>Le mental fort fait la différence entre un joueur chanceux et un joueur rentable.</p>
                            </StrategyItem>
                            <StrategyItem title="24. Ajuster la stratégie">
                                <p>Ne reste pas bloqué sur une méthode qui ne fonctionne pas.</p><p>Observe, teste, corrige et adapte ton approche.</p><p>Exemple : réduire multiplicateur cible si les crashes arrivent trop tôt.</p><p>Changer la taille des mises selon la série de gains ou pertes.</p><p>La flexibilité est un atout majeur dans les jeux de hasard.</p><p>Un joueur qui s’adapte survivra plus longtemps et fera plus de profits.</p>
                            </StrategyItem>
